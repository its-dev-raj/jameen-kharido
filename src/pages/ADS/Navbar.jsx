...
const Navbar = () => {
  return (
    <div className="w-full flex  ">
      <div className="flex px-14 shadow-md justify-center items-center py-2 ">
        <div className="content-center ">
          <img className=" w-20" src={logo} alt="oyo-icon" />
        </div>
        <div className="flex   px-5 gap-4  justify-between border-r ">
          <div className="flex justify-start border cursor-pointer rounded-md ">
            ...
            <p className="p-2 border-r-2 justify-start  bg-white px-8 text-black">
              Thu, 31 Dec - Wed, 1 Jan
            </p>
            <p className="p-2 border-r-2 text-lg  font-semibold border-gray-500 px-8 bg-white text-black">
              1 Room, 1 Guest
            </p>
            <p className="p-2    rounded-r-md bg-[#128036] text-[#FFFFFF] text-xl font-bold  px-12">
              Search
            </p>
          </div>
